...
import { DirectorSelect } from "./ui/DirectorSelect";
...
const MovieFilters = ({ params, setParams }: MovieFiltersProps) => {
  ...
  return (
    <form onSubmit={applyFilters} id="movieFilters" className="flex flex-col gap-4">
      {/* Nazionalità */}
      ...
      <div className="flex flex-col gap-2">
        <label id="director" className="font-medium">Director</label>
        <DirectorSelect 
          id='director'
          name="director"
          onSelect={addParam}
      ...
      <div className="flex flex-col gap-2">
        <label id="genre" className="font-medium">Genre</label>
        <GenreSelect 
          id='genre'
          name="genre"
          onSelect={addParam}
